...
**Background.** My background bridges these two experimental worlds. I developed frequency-comb techniques during my PhD at Politecnico di Milano and through a research stay at the Max Planck Institute for Quantum Optics, focusing on precision spectroscopy and coherent imaging. Since 2022, at CIC nanoGUNE, I have shifted focus to near-field nano-optics, developing s-SNOM-based methodologies to probe nanoscale optical phenomena with spectroscopic detail.

**Perspective.** This dual expertise provides me with a broad experimental toolkit and complementary perspectives: metrological precision from frequency combs and nanoscale spatial resolution from near-field techniques. Together, they enable me to approach surface light–matter interaction from multiple angles, connecting measurements to fundamental physical models across different length and frequency scales.
...
**Work context.** I worked on dual-comb methods at Politecnico di Milano and the Max Planck Institute for Quantum Optics, developing applications in broadband spectroscopy and phase-sensitive imaging.

**Highlights.**
- **Frequency metrology** — Absolute calibration of optical frequencies across octave-spanning bandwidths with Hz-level precision. Enables highly accurate spectroscopy without external wavelength references—establishing traceable links between optical measurements and fundamental constants.
- **Dual-comb spectroscopy** — Replaces mechanical scanning with optical sampling using two combs with slightly different repetition rates. Enables rapid acquisition of broadband spectra (THz to visible) with MHz-level resolution and microsecond acquisition times—orders of magnitude faster than Fourier-transform methods.
- **Dual-comb holography** — Extends metrological precision to coherent imaging by interfering comb sources. Enables scan-free, phase-sensitive wavefront reconstruction and hyperspectral three-dimensional measurements—capturing both amplitude and phase information across hundreds of spectral channels simultaneously.
